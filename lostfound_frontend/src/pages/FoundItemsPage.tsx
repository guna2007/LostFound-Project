...
export default function FoundItemsPage() {
  ...
  const { data: items = [], isLoading } = useItems({ sortBy, status: 'FOUND', category: selectedCategory !== 'all' ? selectedCategory : undefined, query: searchQuery || undefined });
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-full rounded-xl border border-gray-300 bg-white py-3 pl-10 pr-3 text-sm placeholder-gray-500 focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
            />
            {searchQuery && (
              <button
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2">
              <label htmlFor="sort-found" className="text-sm font-medium text-gray-700">Sort:</label>
              <select
                id="sort-found"
                value={sortBy}
            ...
            {filteredItems.map((item) => (
              ...
              >
                ...
                <div className="mt-4 space-y-2">
                  <h3 className="font-bold text-gray-900 line-clamp-1 group-hover:text-green-600">
                    {item.title}
                  </h3>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="pt-4 border-t">
                <button className="w-full rounded-lg bg-green-600 px-4 py-3 font-semibold text-white hover:bg-green-700">
                  This Is My Item
                </button>
              </div>
            </div>
